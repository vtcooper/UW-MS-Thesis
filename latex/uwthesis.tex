...
\acknowledgments{% \vskip2pc
  % {\narrower\noindent
  First, a $CO_2$ acknowledgment: our emissions of carbon dioxide need to decline.  
  
  
  I would like to thank Cecilia Bitz for giving me the opportunity to come to UW, for her mentorship, and for helping me understand how much I could learn from conducting my own experiments. With no previous research experience, she gave me a chance to become a scientist. I would like to thank Lettie Roach for being a fantastic mentor, especially when I showed up at UW as only a tabula rasa. I would like to thank Kyle Armour for welcoming me into his research group in my first days as a curious character at UW and for always being excited to explore big questions. I would like to thank Greg Hakim for his investment in my development and for broadening my research horizons. I would like to thank Jim Thomson for sharing his expertise, for helping me learn so much from this project, and especially for finding a way for me to engage in field research in the Arctic Ocean. I would like to thank Shuyi Chen for lending her wave knowledge and perspectives on wave modeling as a member of my committee.   
  
  Sam Brenner, Maddie Smith, and Mike Meylan all provided insights that helped shape this work, and I am grateful for their collaboration and the knowledge they have shared. I would like to thank the Arctic Mobile Observing System (AMOS) team, especially Craig Lee, for welcoming me aboard the R/V Sikuliaq. The Arctic is glorious. I would also like to thank the UW Program on Climate Change (PCC) for providing a forum where science can be social. I am also grateful for encouragement from my colleagues at Evercore and American Securities. Finally, I thank the United States of America Department of Defense for funding support through a National Defense Science \& Engineering Graduate (NDSEG) Fellowship.
  % \par}
}
